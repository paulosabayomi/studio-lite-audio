...
//     getCurrentColourScheme().setUIColour(ColourScheme::UIColour::windowBackground, Colour::fromFloatRGBA(0.0, 0.0, 0.0, 1.0));
    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::windowBackground, Colour::fromRGB((uint8_t) 42, (uint8_t) 54, (uint8_t) 66));
//    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::windowBackground, Colour::fromString("red"));
    
    
//    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::widgetBackground, Colour::fromFloatRGBA(0.1, 0.1, 0.1, 1.0));
    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::widgetBackground, Colour::fromRGB((uint8_t) 25, (uint8_t) 35, (uint8_t) 43));
//    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::widgetBackground, Colour::fromString("green"));
    
    
//    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::outline, Colour::fromFloatRGBA(0.3, 0.3, 0.3, 0.5));
    getCurrentColourScheme().setUIColour(ColourScheme::UIColour::outline, Colour::fromRGB((uint8_t) 42, (uint8_t) 54, (uint8_t) 66));
    ...
    setColour (TextEditor::backgroundColourId, Colour::fromRGB((uint8_t) 1, (uint8_t) 35, (uint8_t) 43));
//    0xff050505
    setColour (TextEditor::textColourId, Colour (0xffe9e9e9));
    setColour (TextEditor::highlightColourId, Colour (0xff5959f9));
    setColour (TextEditor::outlineColourId, Colour::fromString("transparent"));
    // fromFloatRGBA(0.3, 0.3, 0.3, 0.5)
    setColour (TextEditor::focusedOutlineColourId, Colour::fromString("transparent"));
//    fromFloatRGBA(0.5, 0.5, 0.5, 0.7)
    ...
    setColour (TooltipWindow::textColourId, Colour::fromRGB((uint8_t) 255, (uint8_t) 255, (uint8_t) 255));
    setColour (TooltipWindow::backgroundColourId, Colour::fromRGBA((uint8_t) 42, (uint8_t) 54, (uint8_t) 66, (uint8_t) 200));
// 1291efd9
// 0xeeffff99
