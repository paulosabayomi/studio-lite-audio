...
})
{
    ...
    options.applicationName     = "Studio Lite";
    options.filenameSuffix      = ".xml";
    options.osxLibrarySubFolder = "Application Support/StudioLite";
   #if JUCE_LINUX
    ...
    parentDir = parentDir.getChildFile("StudioLite");
    mDefaultRecordDir = URL(parentDir);
    mLastBrowseDir = mDefaultRecordDir.getLocalFile().getFullPathName();
#endif
    ...
    {
        {
            ...
            if (type == AOO_TYPE_SINK){
                ...
                DBG("Studio Lite bug: unknown aoo type: " << type);
            }
        }
        ...
        DBG("Studio Lite: not a valid AOO message!");
    }
